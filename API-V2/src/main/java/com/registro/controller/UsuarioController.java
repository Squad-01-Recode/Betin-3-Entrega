...
@RestController
@RequestMapping(value = "/betin/usuarios/cadastro")
@CrossOrigin("*")
public class UsuarioController {
	...
	public ResponseEntity autenticar(@RequestBody com.registro.dto.UsuarioDTO dto) {
		try {
			Usuario usuarioAutenticado = service.autenticar(dto.getEmail(), dto.getSenha());
			return ResponseEntity.ok(usuarioAutenticado);
		} catch (com.registro.service.exception.ErroAutenticacao e) {
